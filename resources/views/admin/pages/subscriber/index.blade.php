                    ...
                    <table id="ContactUsTable" class="dataTableHover row-border data-table-filter table-style">
                        ...
                        @foreach ($subscribers as $item)
                            <tr>
                                ...
                                <td><a href="javascript:void(0)" class="btn-action btn-sm" title="{{__('Promotion')}}" data-bs-toggle="modal" data-bs-target="#viewModal{{$item->id}}"><i class="fab fa-telegram-plane"></i></a></td>
                            </tr>
                        @endforeach
                        </tbody>
                    </table>
                    ...
                    <form enctype="multipart/form-data" method="POST" action="{{route('admin.subscribe.promote')}}">
                        <div class="modal-body">
                            ...
                            <div class="input__group mb-25">
                                ...
                                <input type="text" name="email" placeholder="{{__('Email')}}" value="{{$cl->Subscribe}}" readonly>
                            </div>
                            <div class="input__group mb-25">
