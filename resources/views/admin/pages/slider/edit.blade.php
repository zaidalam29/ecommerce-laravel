                                ...
                                <div class="row">
                                        ...
                                        <div class="form-vertical__item bg-style">
                                            ...
                                            <input type="hidden" name="id" id="id" value="{{$edit->id}}">
                                                <div class="input__group mb-25">
                                                    ...
                                                    <input type="text" id="en_title" name="en_title" value="{{$edit->en_Title}}">
                                                </div>
                                                <div class="input__group mb-25">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-vertical__item bg-style">
                                            ...
                                            <div class="input__group mb-25">
                                                <label for="exampleInputEmail1">{{ __('Title')}}</label>
                                                <input type="text" id="fr_title" name="fr_title" value="{{$edit->fr_Title}}">
                                            </div>
                                            <div class="input__group mb-25">
                                                <label for="exampleInputEmail1">{{ __('Sub Title')}}</label>
                                                <input type="text" id="fr_sub_title" name="fr_sub_title" value="{{$edit->fr_Sub_Title}}" >
                                            </div>
                                            <div class="input__group mb-25">
                                                <label for="exampleInputEmail1">{{ __('Button Text')}}</label>
                                                <input type="text" id="fr_btn_text" name="fr_btn_text" value="{{$edit->fr_Button_Text}}">
                                            </div>
                                            <div class="input__group mb-25">
                                                <label for="exampleInputEmail1">{{ __('Description')}}</label>
                                                <textarea id="description" name="fr_description">{{$edit->fr_Description}}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
