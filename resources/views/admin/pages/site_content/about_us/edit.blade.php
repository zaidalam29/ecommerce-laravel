                                        ...
                                        <div class="form-vertical__item bg-style">
                                            ...
                                            @if($edit->fr_Subtitle)
                                                <div class="input__group mb-25">
                                                    ...
                                                    <input type="text" class="form-control" id="fr_subtitle" name="fr_subtitle" required="" value="{{$edit->fr_Subtitle}}">
                                                </div>
                                            @endif
                                            @if($edit->fr_Title_One)
                                                <div class="input__group mb-25">
                                                    <label for="exampleInputEmail1">{{ __('Title One')}}</label>
                                                    <input type="text" class="form-control" id="fr_title_one" name="fr_title_one" required="" value="{{$edit->fr_Title_One}}">
                                                </div>
                                            @endif
                                            @if($edit->fr_Title_Two)
                                                <div class="input__group mb-25">
                                                    <label for="exampleInputEmail1">{{ __('Title Two')}}</label>
                                                    <input type="text" class="form-control" id="fr_title_two" name="fr_title_two" required="" value="{{$edit->fr_Title_Two}}">
                                                </div>
                                            @endif
                                            @if($edit->fr_Title_Three)
                                                <div class="input__group mb-25">
                                                    <label for="exampleInputEmail1">{{ __('Title Three')}}</label>
                                                    <input type="text" class="form-control" id="fr_title_three" name="fr_title_three" required="" value="{{$edit->fr_Title_Three}}">
                                                </div>
                                            @endif
                                            @if($edit->fr_Title_Four)
                                                <div class="input__group mb-25">
                                                    <label for="exampleInputEmail1">{{ __('Title Four')}}</label>
                                                    <input type="text" class="form-control" id="fr_title_four" name="fr_title_four" required="" value="{{$edit->fr_Title_Four}}">
                                                </div>
                                            @endif
                                            @if($edit->fr_Description_One)
                                                <div class="input__group mb-25">
                                                    <label for="exampleInputEmail1">{{ __('Description One')}}</label>
                                                    <textarea name="fr_description_one" id="fr_description_one" class="form-control summernote" required="">{{$edit->fr_Description_One}}</textarea>
                                                </div>
                                            @endif
                                            @if($edit->fr_Description_Two)
                                                <div class="input__group mb-25">
                                                    <label for="exampleInputEmail1">{{ __('Description One')}}</label>
                                                    <textarea name="fr_description_two" id="fr_description_two" class="form-control summernote" required="">{{$edit->fr_Description_Two}}</textarea>
                                                </div>
                                            @endif
                                            @if($edit->fr_Description_Three)
                                                <div class="input__group mb-25">
                                                    <label for="exampleInputEmail1">{{ __('Description One')}}</label>
                                                    <textarea name="fr_description_three" id="fr_description_three" class="form-control summernote" required="">{{$edit->fr_Description_Three}}</textarea>
                                                </div>
                                            @endif
                                            @if($edit->fr_Description_Four)
                                                <div class="input__group mb-25">
                                                    <label for="exampleInputEmail1">{{ __('Description One')}}</label>
                                                    <textarea name="fr_description_four" id="fr_description_four" class="form-control summernote" required="">{{$edit->fr_Description_Four}}</textarea>
                                                </div>
                                            @endif
