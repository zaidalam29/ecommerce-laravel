                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-vertical__item bg-style">
                                            ...
                                            <div class="input__group mb-25">
                                                <label for="exampleInputEmail1">{{ __('Blog Title')}}</label>
                                                <input type="text" class="form-control" id="fr_title" name="fr_title" required="" value="{{$edit->fr_Title}}">
                                            </div>
                                            <div class="input__group mb-25">
                                                <label for="exampleInputEmail1">{{ __('Description One')}}</label>
                                            ...
                                            @if($edit->fr_Description_Two)
                                                <div class="input__group mb-25">
                                                    <label for="exampleInputEmail1">{{ __('Description Two')}}</label>
                                                    <textarea name="fr_description_two" id="fr_description_two" class="form-control summernote">{{$edit->fr_Description_Two}}</textarea>
                                                </div>
                                            @endif
