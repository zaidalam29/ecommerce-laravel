                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-vertical__item bg-style">
                                            ...
                                            <div class="input__group mb-25">
                                                <label for="exampleInputEmail1">{{ __('Blog Title')}}</label>
                                                <input type="text" id="fr_blog_title" name="fr_blog_title" required="" value="{{$edit->fr_Title}}">
                                            </div>
                                            <div class="input__group mb-25">
                                                <label for="exampleInputEmail1">{{ __('Description One')}}</label>
                                                <textarea name="fr_description_one" id="fr_description_one" class="summernote" required="">{{$edit->fr_Description_One}}</textarea>
                                            </div>
                                            <div class="input__group mb-25">
                                                <label for="exampleInputEmail1">{{ __('Description Two')}}</label>
