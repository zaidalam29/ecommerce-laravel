                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-vertical__item bg-style">
                                            ...
                                            <div class="input__group mb-25">
                                                ...
                                                <textarea name="en_description_one" id="en_description_one" class="summernote" required=""></textarea>
                                            </div>
                                            <div class="input__group mb-25">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-vertical__item bg-style">
                                            ...
                                            <div class="input__group mb-25">
                                                <label for="exampleInputEmail1">{{ __('Blog Title')}}</label>
                                                <input type="text" class="form-control" id="fr_blog_title" name="fr_blog_title" required="">
                                            </div>
                                            <div class="input__group mb-25">
                                                <label for="exampleInputEmail1">{{ __('Description One')}}</label>
                                                <textarea name="fr_description_one" id="fr_description_one" class="summernote" required=""></textarea>
                                            </div>
                                            <div class="input__group mb-25">
                                                <label for="exampleInputEmail1">{{ __('Description Two')}}</label>
