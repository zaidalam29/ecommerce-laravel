                            ...
                            @foreach($wishlist as $item)
                                ...
                                <td>
                                    <div class="product-info text-center">
                                        <h3 class="product-name"><a class="product-link" href="{{route('single.product',$item->en_Product_Slug)}}">{{$item->en_Product_Name}}</a></h3>
                                ...
                                <td>
                                    <div class="action-area">
                                        <a href="javascript:void(0)" title="{{__('Add To Cart')}}" data-id="{{$item->id}}" class="add-cart action-btn addCart">{{__('Add To Cart')}} <i class="icon fas fa-plus-circle"></i></a>
                                    </div>
                                </td>
