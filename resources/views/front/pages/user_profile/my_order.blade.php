                                                ...
                                                @forelse ($all_orders as $ao)
                                                    <tr>
                                                        ...
                                                        <td class="my-order-td-row">
                                                            <span class="amount">{{currencySymbol()[currency()]}} {{currencyConverter($ao->Grand_Total)}}</span>
                                                        </td>
                                            ...
                                            <table class="table table-borderless">
                                                ...
                                                @forelse ($delivered_orders as $do)
                                                    <tr>
                                                        ...
                                                        <td class="my-order-td-row">
                                                            <span class="amount">{{currencySymbol()[currency()]}} {{currencyConverter($do->Grand_Total)}}</span>
                                                        </td>
                                            ...
                                            <table class="table table-borderless">
                                                ...
                                                @forelse ($canceled_orders as $co)
                                                    <tr>
                                                        ...
                                                        <td class="my-order-td-row">
                                                            <span class="amount">{{currencySymbol()[currency()]}} {{currencyConverter($co->Grand_Total)}}</span>
                                                        </td>
