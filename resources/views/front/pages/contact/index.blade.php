                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-6">
                                <div class="single-contact-info border-0 text-center">
                                    ...
                                    <p class="contact-info-content">{{__('Send us a text & an ambassador will respond 1-814-251-9966')}}</p>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-6">
                                <div class="single-contact-info text-center">
                                    ...
                                    <p class="contact-info-content">{{__('461 Valencia Street San Francisco, CA 94103 Manhattan NYC')}} </p>
                                </div>
                            </div>
